...
for p in allp:
    ...
    if len(result) > 5:     
        ...
        curs.execute("INSERT INTO leis_artigo ( artigo, created_at, updated_at, lei_id, id_artigo_lei, is_titulo) values (%s, %s, %s, %s, %s, %s)", (string, date.today(), date.today(),  '1' , i, is_titulo))
