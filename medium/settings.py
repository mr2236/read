...
SECRET_KEY = config('SECRET_KEY')# = 'fllfw!^b@@pmr3b(jgf_4*bc0vtmdqjk38@zd1#kovikhfg6+o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)# = True

ALLOWED_HOSTS = ['leie.herokuapp.com/']
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'medium', 'media')
